...
const TabButtons = ({buttons, selectedTab, setSelectedTab}: TabButtonProps) => {
  ...
  return (
    ...
    style={{
        ...
        <Animated.View style={[animatedStyle, {position:'absolute', backgroundColor:'#fff', borderRadius: 15, marginHorizontal: 5, height: dimentions.height - 10, width: buttonWidth - 10 }]}/>
